...
RefreshTokenSchema.statics.createToken = function (user) {
    return __awaiter(this, void 0, void 0, function () {
        var expiredAt, token, newObject, refreshToken;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    expiredAt = new Date();
                    expiredAt.setSeconds(expiredAt.getSeconds() + auth_config_1.default.jwtRefreshExpiration);
                    token = uuid4();
                    newObject = new this({
...
RefreshTokenSchema.statics.verifyExpiration = function (token) { return token.expiryDate.getTime() < new Date().getTime(); };
